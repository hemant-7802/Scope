export default function Contact() {
    return (
        <div className="relative isolate bg-gray-950 px-6 py-16 sm:py-24 lg:px-8">
            <svg
            ...
            <div className="mx-auto max-w-xl lg:max-w-4xl">
                <h2 className="text-4xl font-bold tracking-tight text-gray-200">Get in Touch</h2>
                ...
                <div className="mt-12 flex flex-col gap-16 sm:gap-y-20 lg:flex-row">
                            ...
                            <div>
                                ...
                                <div className="mt-2.5">
                                    <input
                                        ...
                                        className="block w-full rounded-md border-0 bg-gray-800 px-3.5 py-2 text-gray-300 shadow-sm ring-1 ring-inset ring-gray-800/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6"
                                    />
                                </div>
                            </div>
                            <div>
                    ...
                    <div className="lg:mt-6 lg:w-80 lg:flex-none">
                        ...
                        <figure className="mt-8">
                            <blockquote className="text-md font-semibold leading-7 text-gray-300">
                                <p>
                                    "Introducing  to "Scope,
                                    your gateway to a brighter future in the world of technology! At " Scope", we're passionate about empowering individuals with the knowledge and skills they need to excel in the ever-evolving field of computer technology.”
                                </p>
                            </blockquote>
                        </figure>
                    </div>
